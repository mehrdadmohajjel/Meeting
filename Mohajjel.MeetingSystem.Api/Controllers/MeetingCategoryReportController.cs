...
{
    [RoutePrefix("MeetingCategoryReport")]
    public class MeetingCategoryReportController: ApiController
    {
        private readonly BusinessManager _businessManager = new BusinessManager();


        /// <summary>
        ///     لیست جلسات براساس دسته بندی جلسات 
        /// </summary>
        /// <param name="input"></param>
        /// <returns></returns>
        [HttpPost]
        [Route("GetMeetingReportByCategoryId")]
        [RequestModelNullValidation]
        [RequestModelValidation]
        [JwtValidation]
        public IHttpActionResult GetMeetingReportByCategoryId(InputGetMeetingReportByCategoryId input)
        {
            const string storedProcedureName = "[HRS].[prc_GetMeetingReportByCategoryId]";

            var result =
                _businessManager
                    .CallStoredProcedure<InputGetMeetingReportByCategoryId, OutputGetMeetingReportByCategoryId[]>(storedProcedureName, input);
