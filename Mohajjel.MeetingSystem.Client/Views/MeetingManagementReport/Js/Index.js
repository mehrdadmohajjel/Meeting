...
window.motorsazanClient.meetingManagementReport = (function () {
    ...
    const controllerName = "/MeetingManagementReport/";


    function handleDepartmentComboBoxIndexChanged() {
        state.departmentId = dom.filterFormDepartmentListWithPermissionCombo.GetValue();
        tools.hideItem(dom.filterFormDepartmentListWithPermissionComboError);
    }
    function handlefilterFormMeetingTypeComboIndexChanged() {
        state.type = dom.filterFormMeetingTypeCombo.GetValue();
        tools.hideItem(dom.filterFormMeetingTypeComboError);
    }
    ...
    function showMeetingManagementReportListBtnClick() {
        setDom();
    ...
    function isFilterFormValid() {
        ...
        tools.hideItem(dom.filterFormDepartmentListWithPermissionComboError);
        const meetingDepartmentId = dom.filterFormDepartmentListWithPermissionCombo.GetValue();
        const meetingDepartmentIdHasValue = !tools.isNullOrEmpty(meetingDepartmentId);
        if (!meetingDepartmentIdHasValue) {
            isValid = false;
            tools.showItem(dom.filterFormDepartmentListWithPermissionComboError);
        }

        tools.hideItem(dom.filterFormMeetingTypeComboError);
        const meetingtypeId = dom.filterFormMeetingTypeCombo.GetValue();
        const meetingtypeIdHasValue = !tools.isNullOrEmpty(meetingtypeId);
        if (!meetingtypeIdHasValue) {
            isValid = false;
            tools.showItem(dom.filterFormMeetingTypeComboError);
        }
    ...
    async function fillGrid() {
        ...
        const url = controllerName + "FillMeetingManagementReportGrid";

        state.meetingDepartmentId = dom.filterFormDepartmentListWithPermissionCombo.GetValue();
        state.persianStartDate = dom.filterFormPeriodStartDatePicker.val();
        state.persianEndDate = dom.filterFormPeriodEndDatePicker.val();
        state.datePeriodType = dom.filterFormGetDataTypeCombo.GetValue();
        state.type = dom.filterFormGetDataTypeCombo.GetValue();
        const apiParam = {
    ...
    function handlemeetingReportGridBeginCallback(command) {
        ...
        command.callbackUrl =
            `${controllerName}FillMeetingManagementReportGrid?DepartmentId=${state.meetingDepartmentId}&Type==${state.type}&persianStartDate=${state.persianStartDate}&persianEndDate=
    ...
    function setDom() {
        dom.filterFormDepartmentListWithPermissionCombo = ASPxClientComboBox.Cast("filterFormDepartmentListWithPermissionCombo");
        dom.filterFormDepartmentListWithPermissionComboParent = $("#filterFormDepartmentListWithPermissionComboParent");
        dom.filterFormDepartmentListWithPermissionComboError = $("#filterFormDepartmentListWithPermissionComboError");


        dom.filterFormMeetingTypeCombo = ASPxClientComboBox.Cast("filterFormMeetingTypeCombo");
        dom.filterFormMeetingTypeComboParent = $("#filterFormMeetingTypeComboParent");
        dom.filterFormMeetingTypeComboError = $("#filterFormMeetingTypeComboError");
    ...
    return {
        handleDepartmentComboBoxIndexChanged: handleDepartmentComboBoxIndexChanged,
        ...
        handlefilterFormMeetingTypeComboIndexChanged: handlefilterFormMeetingTypeComboIndexChanged,
        showMeetingManagementReportListBtnClick: showMeetingManagementReportListBtnClick,
